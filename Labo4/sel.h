...
//matriz B obtenida de la integracion por partes
...
//matriz M obtenida tambien de la integracion por partes
void createLocalM(Matrix &M,mesh m){
    float l = m.getParameter(ELEMENT_LENGTH);
    float nu = m.getParameter(const_nu);
    M.at(0).at(0) += nu/l;      M.at(0).at(1) += -nu/l;
    M.at(1).at(0) += -nu/l;     M.at(1).at(1) += nu/l;
}
...
void createLocalN(Matrix &N,mesh m){
    float delta = m.getParameter(const_delta);
    N.at(0).at(0) += -delta/2;  N.at(0).at(1) += delta/2;
    N.at(1).at(0) += -delta/2;  N.at(1).at(1) += delta/2;
}

Matrix createLocalK(int element,mesh &m){
    Matrix K,A,B,C,M,D,N;
    ...
    row1.push_back(A.at(0).at(0)+B.at(0).at(0)); //el sistema matricial suata la matriz A+B
    row1.push_back(A.at(0).at(1)+B.at(0).at(1));
    row1.push_back(C.at(0).at(0)+M.at(0).at(0)); //el sistema matricial suata la matriz C+M
    row1.push_back(C.at(0).at(1)+M.at(0).at(1));

    row2.push_back(A.at(1).at(0)+B.at(1).at(0));
    row2.push_back(A.at(1).at(1)+B.at(1).at(1));
    row2.push_back(C.at(1).at(0)+M.at(1).at(0));
    row2.push_back(C.at(1).at(1)+M.at(1).at(1));

    row3.push_back(D.at(0).at(0));
    row3.push_back(D.at(0).at(1));
    row3.push_back(N.at(0).at(0)); //tendremos una nueva matriz a la que hemos llamado N
    row3.push_back(N.at(0).at(1));

    row4.push_back(D.at(1).at(0));
    row4.push_back(D.at(1).at(1));
    row4.push_back(N.at(1).at(0));
    row4.push_back(N.at(1).at(1));
